                            ...
                            <div class="card-body">
                                ...
                                <form action="editarDicasSubmit.php" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control"
                                            id="quantidade_dicas<?php echo $item['quantidade_dicas']; ?>" name="quantidade_dicas"
                                            value="<?php echo $item['quantidade_dicas']; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="id" id="id" class="form-control"
                                            ...
                                            foreach ($lista as $item):
                                                ?>
                                                <option value="<?php echo $item['id']; ?>"><?php echo $item['id']; ?> - <?php echo $item['nome_usuario']; ?>
                                                    </option>
                                                <?php
                                            endforeach;
                                            ?>
                        ...
                        <div class="card-body">
                            <form action="adicionarDicaSubmit.php" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="pacote_dicas" name="pacote_dicas"
                                        required>
                                </div>
                                <div class="mb-3">
                                    <label for="preco_dicas" class="form-label">Preço</label>
                                    <input type="text" class="form-control" id="preco_dicas" name="preco_dicas"
                                        required>
                                </div>
                                <div class="mb-3">
                                    <label for="quantidade_dicas" class="form-label">Quantidade</label>
                                    <input type="text" class="form-control" id="quantidade_dicas"
                                        name="quantidade_dicas" required>
                                </div>
                                <div class="form-group">
