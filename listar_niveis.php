            ...
            <div class="max-w-5xl mx-auto">
                ...
                <div class="level-path">
                    ...
                    for ($i = 1; $i <= $totalLevels; $i++): 
                        ...
                        // Add trophy class to final level
                        if ($i == $totalLevels) {
                    ...
                    <!-- Character & Treasure Chest -->
                    <div class="fixed bottom-10 right-10 z-10">
                        <img src="/api/placeholder/100/120" alt="Character" class="celebration" />
                    </div>
                </div>
            </div>
        </div>
